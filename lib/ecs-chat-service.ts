...
interface EcsChatServiceProps extends StackProps {
  ecrRepoName: string;
...
export class EcsChatServiceStack extends Stack {
  public readonly service: aws_ecs.FargateService;

  constructor(scope: Construct, id: string, props: EcsChatServiceProps) {
    ...
    // taask add container
    task.addContainer("ContainerForChatService", {
    ...
    // service
    const service = new aws_ecs.FargateService(this, "ChatService", {
      vpcSubnets: {
    ...
    props.listener.addTargets("EcsChatServiceTarget", {
      priority: 1,
      conditions: [
    ...
    // export task role
    new CfnOutput(this, "EcsTaskRoleForChatService", {
      value: task.taskRole.roleArn,
      exportName: "EcsTaskRoleForChatService",
    });

    // export task execution role
    new CfnOutput(this, "EcsTaskExecutionRoleForChatService", {
      value: task.executionRole!.roleArn,
      exportName: "EcsTaskExecutionRoleForChatService",
    });
  }
}
